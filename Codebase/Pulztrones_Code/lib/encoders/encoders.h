...
class Encoders {
 public:
   ...
   * and angle.
   */
  // Update method called in each control cycle
  void update();

  // Convenience methods for safe access to recorded values
    /**
...
// External declaration of encoder instance
extern Encoders encoders;

// Callback functions for interrupt service routines
